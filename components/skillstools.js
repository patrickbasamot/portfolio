...
export default function Skills(){
...

   {
    ...
    <div className="snap-center w-screen h-screen flex flex-col px-12 pt-8 md:pt-12">
            ...
            <p className='text-sm pt-3 md:text-base'>Tools I have used <strong className='text-red-500'>before </strong>:</p>
        ...
        <div className='flex items-center pt-6 md:justify-start'>
            <p className='text-sm md:text-base'>Little knowledge about <strong className='text-red-500'>Redux</strong>. </p>
        </div>
        <div className='flex items-center justify-center pt-3 md:justify-start'>
            <p className='text-sm md:text-base'>Knowledgeable about <strong className='text-red-500'>GNU/Linux</strong>   
        ...
        <p className='text-sm md:text-base'> Knowledgeable about <strong className='text-red-500'>C++</strong>  which was my First Programming Language way back my first college years.</p>
        </div>
    </div>
    )
}